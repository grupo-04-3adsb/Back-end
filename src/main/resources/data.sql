...
VALUES ('Materiais de Escritório', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Festas e Eventos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFBD'),
       ('Artesanato', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF33FF'),
       ('Produtos Personalizados', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Brindes Corporativos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#B6FF33'),
       ('Acessórios para Festas', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF9F33'),
       ('Festas Temáticas', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF3368'),
       ('Decoração de Interiores', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Decoração de Natal', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#338AFF'),
       ('Bolsas e Acessórios', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF5733'),
       ('Jogos e Brinquedos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFC4'),
       ('Artigos para Casamento', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Flores e Arranjos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF5733'),
       ('Produtos Ecológicos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFBD'),
       ('Moda e Vestuário', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF33A8'),
       ('Bijuterias e Acessórios', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Cosméticos e Beleza', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#B6FF33'),
       ('Equipamentos de Festa', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF9F33'),
       ('Alimentos e Bebidas', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FF57'),
       ('Livros e Materiais Didáticos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Tecnologia e Gadgets', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFC4'),
       ('Esportes e Atividades ao Ar Livre', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#338AFF'),
       ('Saúde e Bem-Estar', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF5733'),
       ('Fotografia e Vídeo', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFBD'),
       ('Gadgets de Cozinha', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF33A8'),
       ('Brinquedos Educativos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#337BFF'),
       ('Materiais para Scrapbook', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#B6FF33'),
       ('Arte e Pintura', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF9F33'),
       ('Produtos para Animais de Estimação', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Ferramentas e Materiais de Construção', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Moda Infantil', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFC4'),
       ('Roupas de Bebê', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#338AFF'),
       ('Artigos para o Dia das Mães', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Artigos para o Dia dos Pais', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Artigos para o Dia das Crianças', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33A8'),
       ('Equipamentos Esportivos', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Roupas de Inverno', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#B6FF33'),
       ('Roupas de Verão', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#FF9F33'),
       ('Equipamentos de Camping', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Arte Digital', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#5733FF'),
       ('Instrumentos Musicais', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#33FFC4'),
       ('Artigos para Academia', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#338AFF'),
       ('Decoração para Festas de Aniversário', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Artigos para Festivais', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Presentes para Todas as Ocasiões', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33A8'),
       ('Suprimentos para Escritório', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Artigos de Papelaria', DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        '#B6FF33'),
       ('Equipamentos de Segurança', DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF9F33');
...
VALUES ('Canetas e Lápis', 'Canetas e lápis de diversas cores e tipos', 1, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Papelaria Personalizada', 'Papelaria personalizada para eventos', 1,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Decoração para Festas', 'Itens decorativos para festas e eventos', 2,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33FF'),
       ('Festas Infantis', 'Decoração e artigos para festas infantis', 2, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Artesanato em Papel', 'Materiais para fazer artesanato em papel', 3,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#B6FF33'),
       ('Personalização de Brindes', 'Brindes personalizados para empresas', 4,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF9F33'),
       ('Lembrancinhas', 'Lembrancinhas personalizadas para festas', 4, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF3368'),
       ('Camisetas Personalizadas', 'Camisetas com estampas personalizadas', 4,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Brindes para Eventos Corporativos', 'Brindes para eventos e feiras', 5,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#338AFF'),
       ('Balões Personalizados', 'Balões com mensagens ou imagens', 6, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Decoração de Mesa', 'Artigos para decoração de mesa de festas', 6, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFC4'),
       ('Bandeirinhas e Guirlandas', 'Bandeirinhas e guirlandas para festas', 6,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Toalhas de Mesa', 'Toalhas de mesa personalizadas', 6, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Decoração para Casamento', 'Artigos para decoração de casamentos', 11,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33A8'),
       ('Convites Personalizados', 'Convites feitos sob medida para eventos', 11,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Flores Artificiais', 'Flores artificiais para decoração', 13, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#B6FF33'),
       ('Arranjos Florais', 'Arranjos florais personalizados', 13, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF9F33'),
       ('Produtos Sustentáveis', 'Artigos ecológicos e sustentáveis', 14, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Bijuterias Artesanais', 'Bijuterias feitas à mão', 16, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Cosméticos Naturais', 'Produtos de beleza feitos com ingredientes naturais', 17,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFC4'),
       ('Equipamentos de Som', 'Equipamentos para festas e eventos', 18, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#338AFF'),
       ('Gastronomia para Festas', 'Alimentos e bebidas para festas', 19, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Brinquedos para Bebês', 'Brinquedos educativos e seguros para bebês', 25,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Materiais para Pintura', 'Tintas e pincéis para pintura', 28, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33A8'),
       ('Produtos para Cães', 'Acessórios e brinquedos para cães', 29, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Suprimentos para Jardinagem', 'Ferramentas e materiais para jardinagem', 29,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#B6FF33'),
       ('Roupas para Crianças', 'Roupas e acessórios infantis', 30, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF9F33'),
       ('Roupas de Festa', 'Roupas para ocasiões especiais', 30, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FF57'),
       ('Decoração de Natal', 'Itens para decoração natalina', 9, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ...
       ('Instrumentos Musicais para Crianças', 'Instrumentos musicais educativos', 38,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF5733'),
       ('Equipamentos de Yoga', 'Acessórios e equipamentos para yoga', 37, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFBD'),
       ('Flores Naturais', 'Flores frescas para eventos', 13, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#FF33A8'),
       ('Decoração para Festas de Aniversário', 'Itens para festas de aniversário', 40,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#337BFF'),
       ('Roupas de Verão', 'Roupas leves e confortáveis para o verão', 35, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#B6FF33'),
       ...
       ('Brinquedos para Animais de Estimação', 'Brinquedos e acessórios para pets', 29,
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#5733FF'),
       ('Suprimentos para Estudo', 'Materiais escolares e didáticos', 20, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#33FFC4'),
       ('Decoração de Interiores', 'Artigos para decoração de ambientes', 8, DATEADD('DAY', FLOOR(RAND() * 365), NOW()),
        DATEADD('DAY', FLOOR(RAND() * 365), NOW()), '#338AFF');
