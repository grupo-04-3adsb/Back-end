...
VALUES
    ...
    ('Agenda Minnie', 34.90, 'Agenda decorada com a personagem Minnie.', 'A5', 0, 0.30, 'AGENDA-MINNIE',
    ...
    ('Agenda Mickey', 34.90, 'Agenda decorada com a personagem Mickey.', 'A5', 10, 0.30, 'AGENDA-MICKEY',
    ...
    ('Caderno One Piece', 29.90, 'Caderno com capa de One Piece.', 'A5', 0, 0.30, 'CADERNO-ONEPIECE',
    ...
    -- Canecas
    ('Caneca Kratos', 29.90, 'Caneca com o tema Kratos.', '350ml', 0, 0.30, 'CANECA-KRATOS',
    ...
    ('Caneca Playstation', 29.90, 'Caneca com o tema Playstation.', '350ml', 10, 0.30, 'CANECA-PLAYSTATION',
    ...
    ('Caneca Gamer', 29.90, 'Caneca com tema gamer.', '350ml', 10, 0.30, 'CANECA-GAMER',
    ...
    ('Caneca Java', 29.90, 'Caneca com tema Java.', '350ml', 10, 0.30, 'CANECA-JAVA',
     'https://cdn.awsli.com.br/608/608801/produto/25906868/caneca-coffee-java-ee4fc9fb.jpg', false, false, 2, 2,
     '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),

    -- Camisetas
    ('Camisa Angry Birds', 49.90, 'Camisa personalizada com Angry Birds.', 'M', 10, 0.30, 'CAMISA-ANGRYBIRDS',
    ...
    ('Camisa Pokemon', 49.90, 'Camisa personalizada com Pikachu.', 'M', 10, 0.30, 'CAMISA-POKEMON',
    ...
    -- Decoração
    ('Topo de Bolo Vingadores', 49.90, 'Topo de bolo com tema Vingadores.', '30x20cm', 0.15, 0.25,
    ...
    ('Topo de Bolo Barbie', 49.90, 'Topo de bolo com tema Barbie.', '30x20cm', 0.15, 0.25, 'TOPO-BOLO-BARBIE',
    ...
    -- Adesivos
    ('Adesivo Naruto', 9.90, 'Adesivo com tema Naruto.', '10x10cm', 5, 0.20, 'ADESIVO-NARUTO',
     'https://http2.mlstatic.com/D_NQ_NP_958149-MLB54876142860_042023-O.webp', false, false, 3, 8,
     '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),
    ('Adesivo Dev', 9.90, 'Adesivo com tema Dev.', '10x10cm', 5, 0.20, 'ADESIVO-DEV',
    ...
    ('Adesivo Star Wars', 9.90, 'Adesivo com tema Star Wars.', '10x10cm', 5, 0.20, 'ADESIVO-STARWARS',
    ...
    ('Adesivo Harry Potter', 9.90, 'Adesivo com tema Harry Potter.', '10x10cm', 5, 0.20, 'ADESIVO-HARRYPOTTER',
     ...
     false, false, 3, 8, '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),
    ('Adesivo de Música', 9.90, 'Adesivo com tema de música.', '10x10cm', 5, 0.20, 'ADESIVO-MUSICA',
     'https://http2.mlstatic.com/D_NQ_NP_828482-MLB72737668006_112023-O.webp', false, false, 3, 8,
     '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),
    ('Adesivo Retro', 9.90, 'Adesivo com tema retro de jogos.', '10x10cm', 5, 0.20, 'ADESIVO-RETRO',
     'https://http2.mlstatic.com/D_NQ_NP_702242-MLB77858802843_072024-O.webp', false, false, 3, 8,
     '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),
    ('Adesivo de Cidades', 9.90, 'Adesivo com silhuetas de cidades famosas.', '10x10cm', 5, 0.20,
     'ADESIVO-CIDADES', 'https://http2.mlstatic.com/D_NQ_NP_948189-MLB70119768954_062023-O.webp', false, false, 3, 8,
     '1_CIkSOZoyKyb8Yo_E1GUL4TjINu2i0g', true, NOW(), NOW(), 0.50),

    -- Brindes
    ('Brinde Corporativo', 12.90, 'Brinde personalizado para eventos corporativos.', '10x10cm', 10, 0.25,
    ...
    ('Calendário Empresarial', 19.90, 'Calendário para empresas.', 'N/A', 5, 0.20, 'CALENDARIO-EMPRESARIAL',
    ...
    ('Caneta Empresarial', 12.90, 'Caneta personalizada para empresas.', 'N/A', 5, 0.20, 'CANETA-EMPRESARIAL',
