...
INSERT INTO produto (nome, preco_venda, descricao, dimensao, desconto, margem_lucro, sku, url_imagem_principal, personalizavel, personalizacao_obrigatoria, fk_categoria, fk_subcategoria)
VALUES
    ('Caderno Personalizado', 29.90, 'Caderno com capa personalizada e folhas pautadas.', 'A5', 0.10, 0.30, 'CADERNO-001', 'url/imagem/caderno_personalizado.jpg', true, false, 1, 1),
    ('Agenda Semanal', 39.90, 'Agenda personalizada com divisões semanais.', 'A5', 0.15, 0.25, 'AGENDA-001', 'url/imagem/agenda_semanal.jpg', true, false, 1, 2),
    ('Topo de Bolo Personalizado', 49.90, 'Topo de bolo com nome e data do evento.', '30cm', 0.20, 0.35, 'TOPO-001', 'url/imagem/topo_bolo_personalizado.jpg', true, true, 2, 3),
    ('Topo de Bolo Casamento', 69.90, 'Topo de bolo elegante para casamentos.', '30cm', 0.25, 0.40, 'TOPO-002', 'url/imagem/topo_bolo_casamento.jpg', true, true, 2, 4),
    ('Balão de Festa', 9.90, 'Balão de festa de 30cm, disponível em várias cores.', '30cm', 0.05, 0.10, 'BALAO-001', 'url/imagem/balao_festa.jpg', false, false, 3, 5),
    ('Faixa Personalizada', 19.90, 'Faixa personalizada com mensagem para festas.', '2m', 0.10, 0.20, 'FAIXA-001', 'url/imagem/faixa_personalizada.jpg', true, false, 3, 6);

INSERT INTO imagens_produto (url_img_adicional, fk_produto)
VALUES
    ('url/imagem/adicional_caderno.jpg', 1),
...
VALUES
    ('Personalização de Capa', 'Texto', 1),
    ('Cores de Capa', 'Cor', 1),
...
VALUES
    ('Texto em Ouro', 'Texto na capa em efeito dourado', 5.00, 'url/imagem/texto_ouro.jpg', 1),
